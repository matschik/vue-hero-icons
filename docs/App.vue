<template>
  ...
  >
    <div class="flex items-center justify-end bg-gray-800 pt-2">
        <span
      ...
      <svg
        class="h-10 text-white fill-current ml-8 mr-10"
        role="img"
        viewBox="0 0 24 24"
    ...
    <div
      class="flex justify-center font-medium bg-gray-800 text-white pb-12"
    >
